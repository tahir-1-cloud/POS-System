...
(function($, window, document, undefined) {
  $.fn.eocjsNewsticker = function(options) {
    ...
    function create() {
      ...
      self.addClass('eocjs-newsticker').html('<div class="eocjs-newsticker-container"><div class="eocjs-newsticker-one"></div></div>');
        ...
        jsonpCallback: callback,
          ...
          if ($.isPlainObject(data) && !$.isEmptyObject(data)) {
              ...
              if (data.hasOwnProperty(property)) {
                  ...
                  if (content === '') {
                      content = convert('prefix') + "StockLevelAlert :" + " " + data.length + "<p style='display:none'>nbsp;SSSSSSSSSSSSSSSSSSSSSSSSS</p>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + convert('suffix');
                  } else {
                      content = convert('prefix', content) + "StockLevelAlert :" + " " + data.length + "<p style='display:none'>nbsp;SSSSSSSSSSSSSSSSSSSSSSSSS</p>" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + convert('suffix', content);
                  }
            }
            ...
            for (let i = 0; i < data.length; i += 1) {
              ...
              if (content === '') {
                  content = convert('prefix') + "Stock Level Alert :" + " " + data.length +"<p style='display:none'>nbsp;SSSSSSSSSSSSSSSSSSSSSSSSS</p>"+ "&nbsp;" + "&nbsp;&nbsp;&nbsp;&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;"+ convert('suffix');
              } else {
                  content = convert('prefix', content) + "Stock Level Alert :" + " " + data.length + "<p style='display:none'>nbsp;SSSSSSSSSSSSSSSSSSSSSSSSS</p>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + "&nbsp;" + convert('suffix', content);
              }
          } else {
